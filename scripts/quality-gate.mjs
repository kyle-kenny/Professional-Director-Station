...
if (!timeline.includes('addLightKeyframe')) failures.push('light keyframe editing missing from timeline');
if (!timeline.includes('lensPresetList')) failures.push('lens presets missing from timeline');
